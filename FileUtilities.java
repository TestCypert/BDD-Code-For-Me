...
public class FileUtilities {
    ...
    public void GenerateConsolidatedFailuresList()
    {
        ...
        {
            System.out.println("Error Occured inside the GenerateConsolidatedFailuresList function, Error Message ="+t.getMessage());
            logMan.error("Error Occured inside the GenerateConsolidatedFailuresList function, Error Message ="+t.getMessage());
        }
    ...
    public  void WriteToFinalFailureLog(String FailureData)
    {
        ...
        try {
            if(!(FailureData==""))
            {
                ...
                File file = new File(System.getProperty("user.dir")+"\\target\\Failures\\ConsolidatedFailuresList.txt");
                if (!file.exists())
                {
                    file.createNewFile();
                    NeedSeparator=false;
    ...
    public void DeleteFailedJsonFiles(String ConsolidatedFailureListdocumentPath)
    {
        ...
        try
        {
            ...
            String AllFailures;
            AllFailures=fileUtil.ReadFromTextFile(new File(System.getProperty("user.dir")+ConsolidatedFailureListdocumentPath));
            ...
            for(int FailureStringNo=0;FailureStringNo <FailureArray.length;FailureStringNo++)
            {
                ...
                String JsonReportPath=System.getProperty("user.dir")+"\\target\\JSONReports\\"+ExactFailedScenario+".json";
