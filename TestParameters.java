...
public class TestParameters {
	...
	private String currentTestcaseQC;
	...
	/**
	 * Function to get the ALM Test case Name
	 * @return The ALM test case name of of the current test case
	 */
	public String getCurrentTestcaseQC() {
		return currentTestcaseQC;
	}

	/**
	 * Function to set the ALM Test case Name
	 * @return The ALM test case name of of the current test case
	 */
	public void setCurrentTestcaseQC(String currentTestcaseQC) {
		this.currentTestcaseQC = currentTestcaseQC;
	}
}