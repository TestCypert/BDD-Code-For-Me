...
public class ReportThemeFactory {
	 ...
	 * @author Cognizant
	 */
	public enum Theme_CRAFT {
		CLASSIC, MYSTIC, AUTUMN, OLIVE, CUSTOM 
	}

	/**
	 * Function to return the {@link ReportTheme} object based on the color
	 * {@link Theme_CRAFT} specified
	 * 
	 * @param theme
	 *            The color {@link Theme_CRAFT} to be used for the report
	 * @return The {@link ReportTheme} object
	 */
	public static ReportTheme getReportsTheme(Theme_CRAFT theme) {
