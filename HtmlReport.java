...
class HtmlReport implements ReportType {
	...
	public void updateTestLog(String stepNumber, String stepName,
		...
		try {
			...
			case FAIL:
				...
				/*UnComment the Below code while Broken Link Validation */
				/*testStepRow += getTestStepWithoutScreenshot(
						stepDescription, stepStatus );*/
				break;
	...
	private String getTestStepWithScreenshot(String stepDescription, Status_CRAFT stepStatus, String screenShotName) {
		String testStepRow;
		...
		if (reportSettings.shouldLinkScreenshotsToTestLog()) {
			testStepRow = 
					...
					"\t\t\t\t\t <td>" + "<img src='..\\Screenshots\\" + screenShotName + "'>" +
			 					"</img>" + "<br> <a href='..\\Screenshots\\" + screenShotName + "'>Click here to open</a>" +
			 				"</td> \n" +
			 		"\t\t\t\t </tr> \n";
		} else {
			testStepRow = 
